              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all text-gray-800"
                  />
                </div>
                ...
                <select
                  ...
                  className="px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all text-gray-800"
                >
                ...
                <button className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-3 rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl">
                  Tìm kiếm
                </button>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-6xl mx-auto">
                    ...
                    <div className="lg:w-2/3 p-8">
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="flex items-center bg-yellow-50 px-3 py-1 rounded-full">
                          ...
                          <span className="font-semibold text-gray-700">{center.rating}</span>
                        </div>
                      </div>
            ...
            <div className="text-center mt-12">
              <button className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-3 rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl">
                Xem thêm trung tâm
              </button>
            </div>
          </div>
