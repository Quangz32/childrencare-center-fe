        ...
        <div className="w-full h-full px-4 md:px-10 flex flex-col">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6 mb-8 mt-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-black mb-2 max-w-2xl">
                Cảm ơn bạn đã đồng hành cùng con trên hành trình đặc biệt này.
                Chúng tôi luôn ở đây để hỗ trợ bạn và bé!
              </p>
              <button
          ...
          <div className="w-full flex flex-col gap-4">
            ...
            />
            <ProfileRow
              icon={<FaPhone className="text-pink-400" />}
              label="Số điện thoại"
              value={profile.phone}
            />
            <ProfileRow
              icon={<FaTransgender className="text-green-400" />}
              label="Giới tính"
            ...
            <ProfileRow
              ...
              label="Vai trò"
              value={profile.role === "parent" ? "Phụ huynh" : profile.role}
            />
          </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-md relative">
            ...
            <div className="flex flex-col gap-4">
              ...
              {pwError && (
                <div className="text-red-600 text-sm mt-1">{pwError}</div>
              )}
            </div>
            <div className="flex justify-end gap-2 mt-6">
              <button
